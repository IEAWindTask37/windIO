...
import pytest
from windIO.utils.yml_utils import load_yaml, validate
...
def test_wind_farm_input(subtests):
    ...
    with subtests.test("with valid config"):
        ...
        assert validate(config, plant_schemas_path + "wind_farm.yaml") is None
...
def test_wind_farm_invalid_inputs_layouts(subtests):
    ...
    with subtests.test("missing layouts"):
        ...
        with pytest.raises(ValidationError):
            validate(config, plant_schemas_path + "wind_farm.yaml")
